...
class StockLot(models.Model):
    ...
    quality_check_qty = fields.Integer(compute='_compute_quality_check_qty', groups='esl_quality_control.group_quality_user')
    quality_alert_qty = fields.Integer(compute='_compute_quality_alert_qty', groups='esl_quality_control.group_quality_user')
    ...
    def action_open_quality_checks(self):
        self.ensure_one()
        action_values = self.env['ir.actions.act_window']._for_xml_id('esl_quality_control.quality_check_action_production_lot')
    ...
    def action_lot_open_quality_alerts(self):
        action = self.env["ir.actions.act_window"]._for_xml_id("esl_quality_control.quality_alert_action_check")
        action.update({
